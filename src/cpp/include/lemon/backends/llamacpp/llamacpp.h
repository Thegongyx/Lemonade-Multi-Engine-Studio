...
inline const BackendDescriptor descriptor = {
    ...
    /*options*/ {
        {"llamacpp_engine", "--llamacpp-engine", "", "STRING",
         "Named custom llama.cpp engine build (config.json llamacpp.custom_engines); overrides llamacpp_backend and the binary path", "Llama.cpp Backend Options"},
    ...
    /*config_extra*/    {{"prefer_system", true}, {"custom_engines", nlohmann::json::object()}, {"engines_dir", ""}},
};
